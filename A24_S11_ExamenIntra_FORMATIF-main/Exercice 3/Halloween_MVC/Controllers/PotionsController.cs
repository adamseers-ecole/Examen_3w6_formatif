...
namespace Halloween.Controllers
{
    public class PotionsController : Controller
    {
        ...
        public async Task<IActionResult> Grimoire(int? id)
        {
            ...
            grimoire_VM.ListePotions = await _context.Potions.ToListAsync();
        ...
        public IActionResult Create()
        {
            ...
            // Corrigez le code suivant afin d'utiliser le SelectListItem du ViewModel Potion VM
            ViewData["Sorciere_Id"] = new SelectList(_context.Sorcieres, "Id", "Nom");

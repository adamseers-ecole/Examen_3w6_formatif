...
namespace MonApp_MVC.Migrations
{
    ...
    [Migration("20240812110737_Add_Equipe_Tournois")]
    partial class Add_Equipe_Tournois
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonApp_MVC.Entities.EquipeTournois", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MonApp_MVC.Entities.EquipeTournois", b =>
                {
                    b.HasOne("MonApp_MVC.Entities.Equipe", "Equipe")
                        .WithMany("EquipeTournois")
                        .HasForeignKey("Equipe_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MonApp_MVC.Entities.Tournois", "Tournois")
                        .WithMany("EquipeTournois")
                        .HasForeignKey("Tournois_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
